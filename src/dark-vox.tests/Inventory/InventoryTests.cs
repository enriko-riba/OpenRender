...
public class InventoryTests
{
    ...
    /// </summary>
    private static DarkVox.Shared.Gameplay.Inventory CreateEmptyInventory()
    {
        return new DarkVox.Shared.Gameplay.Inventory();
    }
    ...
    [Fact]
    public void AddItem_WhenOnlyInStorage_ShouldSeedHotbarFirst()
    {
        var inventory = CreateEmptyInventory();

        // Storage contains stones, hotbar does not.
        inventory.SetItem(9, new InventoryItem { Item = GameObjectId.Stone, Count = 10 });

        // Pick up 1 stone; expected UX: hotbar gets repopulated.
        ...
        // Storage should have stacked the remaining pickup.
        var storageItem9 = inventory.GetItem(9);
        Assert.Equal(GameObjectId.Stone, storageItem9.Item);
        Assert.Equal(10, storageItem9.Count);
    }
    ...
    public void AddItem_WhenHotbarFull_ShouldGoDirectlyToStorage()
    {
        ...
        for (var i = 0; i < DarkVox.Shared.Gameplay.Inventory.HotbarSize; i++)
        {
    ...
    public void ReturnItemToStorage_WhenStorageFull_ShouldReturnRemaining()
    {
        ...
        for (var i = DarkVox.Shared.Gameplay.Inventory.HotbarSize; i < DarkVox.Shared.Gameplay.Inventory.SlotCount; i++)
        {
    ...
    public void SelectedSlot_ShouldClampToValidRange()
    {
        ...
        Assert.Equal(DarkVox.Shared.Gameplay.Inventory.HotbarSize - 1, inventory.SelectedSlot);
    }
