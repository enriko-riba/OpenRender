...
public class Chunk(int index)
{
    ...
    /// </summary>
    public void ApplyColumnSpansForCollision(int[] spansPairs, byte[] counts, BlockId[] types)
    {
    ...
    /// </summary>
    public void RebuildColumnSpans(int localX, int localZ, ChunkData voxelData)
    {
    ...
    /// </summary>
    public void RebuildAllCollisionSpans(ChunkData voxelData)
    {
        var size = VoxelHelper.ChunkSideSize;
        for (var z = 0; z < size; z++)
        {
    ...
    /// </summary>
    public bool TryGetSpanData(out int[] spansPairs, out byte[] counts, out BlockId[] types)
    {
    ...
    /// </summary>
    public BlockId GetBlockFromSpans(int lx, int ly, int lz, int maxSpans)
    {
